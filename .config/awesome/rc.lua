...
awful.key({ "Control", "Shift"}, "q", function() awful.util.spawn("/home/emind/software/Qt5.7.0/Tools/QtCreator/bin/qtcreator") end),

-- {{ Spawns pycharm }} --

awful.key({ "Control", "Shift"}, "p", function() awful.util.spawn("/home/emind/software/pycharm-4.5.4/bin/pycharm.sh") end),

-- {{ Spawns wechat }} --
awful.key({ "Control", "Shift"}, "w", function() awful.util.spawn("/home/emind/software/electronic-wechat-linux-x64/electronic-wechat") end),
